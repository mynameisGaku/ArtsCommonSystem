...
// HelloAnimCurveEditor — FScene。Workspace + 1 panel + 1 FAnimationCurve
...
class AnimCurveScene : public acs::game::FScene {
public:
...
private:
    ...
    // 編集対象の FAnimationCurve。FScene が所有し、panel は raw 参照を保持する。
