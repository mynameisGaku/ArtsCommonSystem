...
acs::Mat4 BuildJitteredViewProjection(HelloIblApp& app, const acs::Mat4& vp_no_jitter,
                                      acs::u32 hdr_width, acs::u32 hdr_height) noexcept;
void RenderShadowPass(HelloIblApp& app, const acs::Vec3& sun_dir) noexcept;
acs::Vec3 ResolveSunDirection(const HelloIblApp& app) noexcept;
void BindPbrLighting(HelloIblApp& app, const acs::Mat4& vp_for_render,
...
void RenderRefractionPass(HelloIblApp& app, const acs::Mat4& vp_for_render,
                          const acs::Viewport& vp, const acs::ScissorRect& svr) noexcept;
void RenderMotionAndNormalGBuffer(HelloIblApp& app,
                                  const acs::Mat4& vp_no_jitter) noexcept;
void RenderSsrPass(HelloIblApp& app, const acs::Mat4& vp_for_render,
                   const acs::Mat4& inv_vp, const acs::Mat4& vp_no_jitter) noexcept;
void RenderSsaoPass(HelloIblApp& app, const acs::Mat4& vp_for_render,
                    const acs::Mat4& inv_vp, const acs::Vec3& sun_dir) noexcept;
void RenderSsgiPass(HelloIblApp& app, const acs::Mat4& vp_for_render,
                    const acs::Mat4& inv_vp, const acs::Mat4& vp_no_jitter) noexcept;
...
private:
    ...
    friend acs::Mat4 BuildJitteredViewProjection(HelloIblApp&, const acs::Mat4&,
                                                 acs::u32, acs::u32) noexcept;
    friend void RenderShadowPass(HelloIblApp&, const acs::Vec3&) noexcept;
    friend acs::Vec3 ResolveSunDirection(const HelloIblApp&) noexcept;
    friend void BindPbrLighting(HelloIblApp&, const acs::Mat4&, const acs::DirLight&) noexcept;
    ...
    friend void RenderRefractionPass(HelloIblApp&, const acs::Mat4&,
                                     const acs::Viewport&, const acs::ScissorRect&) noexcept;
    friend void RenderMotionAndNormalGBuffer(HelloIblApp&, const acs::Mat4&) noexcept;
    friend void RenderSsrPass(HelloIblApp&, const acs::Mat4&, const acs::Mat4&,
                              const acs::Mat4&) noexcept;
    friend void RenderSsaoPass(HelloIblApp&, const acs::Mat4&, const acs::Mat4&,
                               const acs::Vec3&) noexcept;
    friend void RenderSsgiPass(HelloIblApp&, const acs::Mat4&, const acs::Mat4&,
                               const acs::Mat4&) noexcept;
    ...
    acs::Mat4               _prev_vp_no_jitter{};      // 前フレームの jitter なし VP
    ...
    acs::UniquePtr<acs::IRhiTexture> _bg_rt;           // 屈折用 background キャプチャ
