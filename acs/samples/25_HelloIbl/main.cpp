...
//   IblEnvBuilder.{h,cpp}       - CPU equirect 生成 (CSky procedural / Studio HDR)
//   IblLightmapBaker.{h,cpp}    - 床用 lightmap CPU baker (FSphere-FRay analytical)
//   HelloIblApp.{h,cpp}          - CApplication 派生 (orchestration のみ)
...
//     - 1/2/3 で CSky preset (Day / Sunset / Night) 切替 → cubemap 再生成
...
ACS_DEFINE_MAIN(helloibl::CHelloIblApp)
