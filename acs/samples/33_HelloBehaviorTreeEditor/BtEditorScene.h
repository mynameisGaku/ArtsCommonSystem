...
// HelloBehaviorTreeEditor — Scene。BT 構築 + panel 構成 + render を担当。
//
// 構成:
...
// ----------------------------------------------------------------------------
struct BtEditorBb {
    acs::game::btedit::BehaviorTreeEditorPanel* panel = nullptr;

    // Action 関数が panel.SetNodeStatus に渡す node_id (sample が AddNode で
    // 払い出した値をそのまま保持)。
    acs::u32 id_pickup = acs::game::btedit::BehaviorTreeEditorPanel::kInvalidId;
    acs::u32 id_move   = acs::game::btedit::BehaviorTreeEditorPanel::kInvalidId;
    acs::u32 id_wait   = acs::game::btedit::BehaviorTreeEditorPanel::kInvalidId;
    acs::u32 id_attack = acs::game::btedit::BehaviorTreeEditorPanel::kInvalidId;
    ...
    acs::u32 id_root     = acs::game::btedit::BehaviorTreeEditorPanel::kInvalidId; // Selector
    acs::u32 id_branch_a = acs::game::btedit::BehaviorTreeEditorPanel::kInvalidId; // Sequence "Pickup Branch"
    acs::u32 id_branch_b = acs::game::btedit::BehaviorTreeEditorPanel::kInvalidId; // Sequence "Combat Branch"
...
private:
    ...
    BtEditorBb                                         _bb;
    acs::game::btedit::BehaviorTreeEditorPanel         _panel;
};
