...
//
// 「panel に教えるメタミラー node 構造」と「実 BT (BtSelector / BtSequence /
// BtAction) の構築」を 1:1 対応で組む責務を Scene 本体から分離する。Scene は
...
void BuildPanelMirror(acs::game::btedit::BehaviorTreeEditorPanel& panel,
...
void BuildBehaviorTree(acs::game::BehaviorTree& bt) noexcept;
