...
void HelloUIApp::OnShutdown() noexcept {
    ...
    // ここで明示的に m_Root.Reset() すると Observable<f32>::value 等が先に死に、
...
void HelloUIApp::BuildUI() noexcept {
    ...
    auto* btn = m_Root->Add<Button>("攻撃を受ける (-10 HP)");
    ...
    auto* btn_heal = m_Root->Add<Button>("満タン回復");
