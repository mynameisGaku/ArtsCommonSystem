...
// CApplication 派生はリソース所有 (CSpriteBatch / FFont / Texture) を担当し、
...
public:
    ...
    // CSpriteBatch + テクスチャ + フォントを使って描画。
    void Render(acs::CSpriteBatch& batch,
                acs::FFont& font,
