...
//
// 動作:
//   ・editor_core::CEditorWorkspace を 1 個立てて、spriteatlas::ASpriteAtlasEditorPanel
//     を register する。
...
//
// ACS_GAME_MAIN は SpriteAtlasApp を main エントリに登録 (CApplication 派生 →
// `int WINAPI WinMain` / `int main` 両方の通常 main を裏で生成)。
#include "SpriteAtlasApp.h"

ACS_GAME_MAIN(hellosa::CSpriteAtlasApp)
