...
void CSpriteAtlasApp::OnStart() noexcept {
...
void CSpriteAtlasApp::OnRender() noexcept {
...
void CSpriteAtlasApp::OnShutdown() noexcept {
...
void CSpriteAtlasApp::OnEvent(const FEvent& e) noexcept {
    m_Imgui.OnEvent(e);
    CGame::OnEvent(e);
}

TUniquePtr<AScene> CSpriteAtlasApp::InitialScene() noexcept {
    return MakeUnique<ASpriteAtlasScene>();
}
