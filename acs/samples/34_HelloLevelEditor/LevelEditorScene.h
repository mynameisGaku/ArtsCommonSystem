...
// HelloLevelEditor — FScene。Workspace + FLevelEditorPanel + FTilemap (32x32, 2 layer)。
//
// 初期 tilemap パターン:
...
class LevelEditorScene : public acs::game::FScene {
public:
...
private:
    ...
    // 編集対象 FTilemap。FLevelEditorPanel に raw 参照で渡す (所有は本 FScene 側)。
