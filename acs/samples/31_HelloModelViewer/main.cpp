...
//   ModelViewerApp.{h,cpp}        - FGame 派生クラス (ImGui lifecycle ラッパ)
...
//
// 動作:
//   ・editor_core の FEditorWorkspace / FAssetBrowser / FEditorTheme と、modelview/
//     配下 4 panel (FModelViewerPanel / FModelInspectorPanel / FModelMaterialPanel /
...
//     Layout は editor_core::FEditorWorkspace::SaveLayout/LoadLayout を呼ぶ。
//     Theme は FEditorTheme::DrawThemeSettingsUI() を toggle で開閉。
//   ・Esc で終了。
//
...
//   ・animation frame 適用 — FModelAnimationPanel::Tick は時間だけ進める。
