...
//
// なぜ独立クラスにしたか:
//   File 系コールバックは UI 入力を FScene 状態へ届ける薄いブリッジでしかなく、
//   3D 描画 (ViewerScenePipeline) や panel layout (ViewerPanels) と完全に
//   直交する。FScene 本体から切り出すと UI 変更が render path に波及しなくなる。
#pragma once
...
public:
    ...
    // Quit や Layout 保存/復元など FScene 横断の副作用は FGame/Workspace/Theme に
