...
//   FViewModel = この基底を継承して FObservable<T> プロパティを公開するクラス
//
// 使い方:
//   class PlayerViewModel : public FViewModel {
//   public:
//       FObservable<f32>     hp     { 100.0f };
//       FObservable<f32>     mana   { 50.0f };
//       FObservable<i32>     level  { 1 };
//       FObservable<bool>    invincible { false };
//   };
//
//   // モデル (実データ) からの反映:
...
//   ・派生クラスが FObservable<T> をメンバに持って公開する
