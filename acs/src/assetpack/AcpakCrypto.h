...
//     ACS_ERR(FAsset, kAcpakSubBadCrc) として返す (= 改竄 / 破損の単一窓口)。
...
public:
    ...
    // 主なエラー:
    //   ・ACS_ERR_OS(FAsset, kAcpakSubCryptoInit, ...) — algorithm provider 取得失敗
    //   ・ACS_ERR_OS(FAsset, kAcpakSubCryptoKdf,  ...) — KDF 計算失敗
    ...
    // 主なエラー:
    //   ・ACS_ERR_OS(FAsset, kAcpakSubCryptoInit, ...) — provider / key 失敗
    //   ・ACS_ERR_OS(FAsset, kAcpakSubCryptoOp,   ...) — BCryptEncrypt 失敗
    ...
    // 主なエラー:
    //   ・ACS_ERR_OS(FAsset, kAcpakSubCryptoInit, ...) — provider / key 失敗
    //   ・ACS_ERR(FAsset, kAcpakSubCryptoTag, ...)    — タグ検証失敗 (改竄 or 破損)
    //   ・ACS_ERR_OS(FAsset, kAcpakSubCryptoOp, ...)  — その他 BCryptDecrypt 失敗
