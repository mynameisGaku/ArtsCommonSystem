...
void CNavGrid::Init(u32 width, u32 height) noexcept {
    m_Width  = width;
    m_Height = height;
...
void CNavGrid::ClearWalls() noexcept {
...
f32 CNavGrid::Heuristic(u32 x, u32 y, u32 goal_x, u32 goal_y) const noexcept {
