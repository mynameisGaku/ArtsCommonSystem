...
// GameFramework Pillar — animcurve / FAnimCurveEditorPanel (Phase 22)
//
...
// 簡易版に相当。Phase 21a で確立された `editor_core::FEditorPanel` 基底に
...
//   ・curve のシリアライズ (= FAnimationCurve 自体に Save/Load を追加する
...
public:
    ...
    // 非コピー / 非ムーブ: 基底 FEditorPanel と同規約 + 内部の curve 参照 /
    ...
    // 編集対象の FAnimationCurve を raw 参照でセット (nullptr で解除)。
    ...
    // 現在編集対象の FAnimationCurve (未バインド時は nullptr)。
    ...
    //   cb   : `void (*)(void* user, FAnimationCurve* curve) noexcept`
