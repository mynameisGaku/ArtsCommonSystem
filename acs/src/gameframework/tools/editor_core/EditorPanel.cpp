...
// GameFramework Pillar — editor_core / EditorPanel 実装 (Phase 21a)
//
// 設計のポイント (詳細はヘッダ参照):
...
//     基底自体は instantiate されないが、`virtual ~EditorPanel()` のために
...
// ============================================================================
// 派生クラスが override する際は冒頭で `EditorPanel::OnInit(workspace);` を
...
// `EditorPanel::OnShutdown()` を明示的に呼べる形にするかは Phase 21b で
// 利用パターンが揃ってから判断する (= YAGNI、現状は OnInit 1 回 + 終生有効
// の典型ケースのみ想定)。
// ============================================================================
void EditorPanel::OnInit(EditorWorkspace& workspace) noexcept {
