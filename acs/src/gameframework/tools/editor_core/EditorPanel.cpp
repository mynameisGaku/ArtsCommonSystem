...
// GameFramework Pillar — editor_core / AEditorPanel 実装
//
// 設計のポイント (詳細はヘッダ参照):
...
//     基底自体は instantiate されないが、`virtual ~AEditorPanel()` のために
 ...
 *
 * @details
 * 派生クラスが override する際は冒頭で AEditorPanel::OnInit(workspace) を呼ぶこと。
 ...
 */
void AEditorPanel::OnInit(CEditorWorkspace& workspace) noexcept {
