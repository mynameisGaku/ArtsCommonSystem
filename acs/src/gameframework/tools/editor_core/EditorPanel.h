...
//       - OnSelectionChanged: FScene 内の FNode 選択 (FSelectionService 経由)
...
//     FEditorLayoutSerializer 本体が未実装。型は forward-decl で受け、派生 panel が
...
//   ・FLocalization (Title 文字列は当面英語固定)
...
public:
    ...
    // FScene 内 FNode の選択が変わったときに呼ばれる (Phase 20 FSelectionService
