...
//     実際の 3D 描画 (FPbrShader / FShadowMap / IBL) は Sample 31 側の
...
//     FModelMaterialPanel / FModelAnimationPanel / Sample 31。本 panel から
...
//   ・grid / gizmo の実描画 = FEditorGizmo (Phase 21a 既存) を Sample 31 で組合せ
...
public:
    ...
    // 寿命は本 panel の寿命と同一。
    acs::game::editor_core::FEditorCamera& FCamera() noexcept;
