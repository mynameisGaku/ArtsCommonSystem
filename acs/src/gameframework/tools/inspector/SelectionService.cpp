...
// GameFramework Pillar — SceneInspector / CSelectionService 実装
//
// 設計のポイント (詳細はヘッダ参照):
...
void CSelectionService::Init() noexcept {
...
void CSelectionService::SelectNode(FNodeId id) noexcept {
...
void CSelectionService::ClearSelection() noexcept {
...
FNodeId CSelectionService::CurrentSelection() const noexcept {
    return m_Current;
}

/** 指定 id が現選択と完全一致するかを返す。 */
bool CSelectionService::IsSelected(FNodeId id) const noexcept {
...
void CSelectionService::UnregisterCallback(SelectionChangeCallback cb, void* user) noexcept {
...
void CSelectionService::ClearAll() noexcept {
