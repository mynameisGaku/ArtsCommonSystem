...
const FSettingDesc kSchema[] = {
    ...
    { "Rendering", "SkyMode",       ESettingType::Int,   "1",              nullptr,
      "3D 空モデル。0=CSky (グラデ+解析太陽) / 1=CAtmosphere (物理大気散乱 Rayleigh+Mie、背景と IBL が物理ベース)。GPU経路失敗時はCPU散乱積分へ落ちる。雲は別の CVolumetricClouds を使う" },
