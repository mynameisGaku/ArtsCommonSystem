...
// GameFramework Pillar R/I — HungerSystem (Survival ジャンルキット: 空腹/喉/疲労/睡眠)
//
...
//
//   // 3) コールバックを attach (HealthSystem への bridge)
...
// zero_damage_per_sec: stat == 0 のとき、1 秒あたり HealthSystem へ通知するダメージ。
