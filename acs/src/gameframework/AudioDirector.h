...
//   ・**clip 直接再生 API (Phase 2 で追加)**: `PlayBgmClip(const FAudioClipDesc&,
...
//     Phase 3 で FStringView / FAsset Handle に置き換える。
...
private:
    ...
    // ----- SFX ring (固定容量) -----
    TArray<FSfxEntry> _sfx;   // 容量 kMaxSfxVoices で reserve、サイズも同じく予約
