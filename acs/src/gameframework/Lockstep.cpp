...
//     PRIME = 0x100000001B3。各 FInputFrame の bit パターンを 8 バイト境界で
...
// -----------------------------------------------------------------------------
// Phase M-2 の擬似コード:
//   1. required = 16 (header) + frame_count * sizeof(FInputFrame) + 4 (footer)
...
//   4. frame_count * sizeof(FInputFrame) + 20 が size と一致しなければ kSub_BadSize
