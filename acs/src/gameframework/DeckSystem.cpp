...
/** 山札の枚数を返す。 */
u32 CDeckSystem::DeckSize()    const noexcept { return static_cast<u32>(m_Deck.Size());    }

/** 手札の枚数を返す。 */
u32 CDeckSystem::HandSize()    const noexcept { return static_cast<u32>(m_Hand.Size());    }

/** 捨札の枚数を返す。 */
u32 CDeckSystem::DiscardSize() const noexcept { return static_cast<u32>(m_Discard.Size()); }

/** 除外ゾーンの枚数を返す。 */
u32 CDeckSystem::ExileSize()   const noexcept { return static_cast<u32>(m_Exile.Size());   }
