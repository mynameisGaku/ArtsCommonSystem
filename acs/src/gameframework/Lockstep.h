...
//
//   // ゲームループ (Local 中):
//   FInputFrame f{ _tick, /*player_id=*/0, _buttons, _stick };
//   ls.RecordInput(f);
//   // ... シミュレーションに f を反映 ...
//   ++_tick;
//
...
//     `acs::FFileSystem::WriteAllBytes` + CRC-32 footer を入れる。
...
// =============================================================================
// FInputFrame — 1 tick 分の入力 (1 プレイヤー分)
// -----------------------------------------------------------------------------
...
public:
    ...
    // 共通エラー subcode (FSaveSlot / BackendClient と同じ pattern)。
