...
// ---- FScoreEntry: 1 回の AddScore() に対応する記録 --------------------------
...
public:
    ...
    // ---- スコア加算 -------------------------------------------------------
    // base × current_multiplier を CurrentScore に加算し、FScoreEntry log に
...
private:
    ...
    // FScoreEntry を log に push (capped append)。
