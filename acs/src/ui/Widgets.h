...
// ---- 共通 colorset (簡易テーマ) -------------------------------------------
struct UiColors {
    Vec4 panel_bg     = { 0.16f, 0.18f, 0.24f, 0.95f };
    Vec4 panel_border = { 0.40f, 0.45f, 0.55f, 0.80f };
    Vec4 button_bg    = { 0.25f, 0.40f, 0.65f, 1.0f };
    Vec4 button_hover = { 0.35f, 0.55f, 0.85f, 1.0f };
    Vec4 button_press = { 0.18f, 0.30f, 0.50f, 1.0f };
    Vec4 button_text  = { 1.0f, 1.0f, 1.0f, 1.0f };
    Vec4 slider_track = { 0.20f, 0.20f, 0.25f, 1.0f };
    Vec4 slider_fill  = { 0.45f, 0.65f, 0.95f, 1.0f };
    Vec4 slider_knob  = { 0.85f, 0.90f, 1.0f, 1.0f };
    Vec4 check_box    = { 0.20f, 0.22f, 0.28f, 1.0f };
    Vec4 check_mark   = { 0.45f, 0.85f, 0.45f, 1.0f };
    Vec4 text         = { 1.0f, 1.0f, 1.0f, 1.0f };
    Vec4 text_dim     = { 0.7f, 0.75f, 0.85f, 1.0f };
    Vec4 input_bg     = { 0.10f, 0.12f, 0.16f, 1.0f };
    Vec4 input_focus  = { 0.20f, 0.30f, 0.50f, 1.0f };
};
...
public:
    explicit Label(const char* initial = "") noexcept : text(String{initial}) {
        requested.h = 22.0f;
    }
...
public:
    explicit Button(const char* label = "Button") noexcept : text(String{label}) {
        requested.h = 32.0f;
    }
...
public:
    explicit Checkbox(const char* label = "") noexcept : text(String{label}) {
        requested.h = 24.0f;
    }
...
public:
    ...
    void OnTextInput(u32 codepoint) noexcept override {
        ...
        const usize len = 0;  // String の length getter が無いので空文字列扱い → 前の値の末尾追加は別途
        (void)len;
        // 仮実装: 単純連結
        // ACS String は AppendFormat 等あるが、ここでは新規 String を作って差し替える
