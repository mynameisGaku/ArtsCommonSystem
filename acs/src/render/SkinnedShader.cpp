...
Result<void> SkinnedShader::Init(IRhiDevice& device, Format rt_format, Format depth_format) noexcept {
    // === シェーダ ===
    ShaderDesc vs_d{};
    ...
    pd.layout[3] = { "BLENDINDICES", 0, Format::R8G8B8A8_UInt,      40 };
    pd.layout[4] = { "BLENDWEIGHT",  0, Format::R32G32B32A32_Float, 44 };
    pd.layout_count = 5;
