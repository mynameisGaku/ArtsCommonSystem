...
function(acs_finalize_modules)
    ...
    foreach(mod ${enabled})
        ...
        set(src_paths "")
        foreach(s ${srcs}) list(APPEND src_paths "${srcdir}/${s}") endforeach()
        set(hdr_paths "")
        foreach(h ${hdrs}) list(APPEND hdr_paths "${srcdir}/${h}") endforeach()
        ...
        foreach(d ${pd}) target_link_libraries(${tgt} PUBLIC  "ACS::${d}") endforeach()
        foreach(d ${rd}) target_link_libraries(${tgt} PRIVATE "ACS::${d}") endforeach()
        foreach(l ${lp}) target_link_libraries(${tgt} PUBLIC  ${l})        endforeach()
        foreach(l ${lr}) target_link_libraries(${tgt} PRIVATE ${l})        endforeach()
    endforeach()
