...
function(acs_third_party_ufbx)
    ...
    set_target_properties(acs_third_party_ufbx PROPERTIES FOLDER "ThirdParty")
endfunction()
...
function(acs_third_party_openxr)
    ...
    elseif(TARGET openxr_loader)
        ...
        set_target_properties(openxr_loader PROPERTIES FOLDER "ThirdParty/OpenXR")
    else()
...
function(acs_third_party_lua)
    ...
    set_target_properties(acs_third_party_lua PROPERTIES FOLDER "ThirdParty")
...
function(acs_third_party_diligent)
    ...
    foreach(_t ${_diligent_targets})
        if(TARGET ${_t})
            set_target_properties(${_t} PROPERTIES FOLDER "ThirdParty/Diligent")
        endif()
    endforeach()
