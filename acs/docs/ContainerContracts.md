...
公開 signature の索引と短い例は [Container API reference](reference/container.html) に置く。
...
| JSON parse 上限、allocator 伝播、write の transaction | [`json_tests.cpp`](../tests/json_tests.cpp) |
