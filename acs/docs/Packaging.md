...
`EMPTY3D`, `CMP3D`, `CPROP3D`, `PLY3D`, `SPR3D`, `PFAB3D`, and `SEL3D`, including sparse IDs and
...
`SPR3D` texture paths and non-executing `PFAB3D` instance-source links are validated,
