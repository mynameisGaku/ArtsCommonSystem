  ...
  types: [
    {
      ...
      members: [
        ...
        { sig: "using FAudioEngine = CAudioEngine", desc: "旧名を使う既存コード向けの一時的な互換別名。新しいコードでは <code>CAudioEngine</code> を使う。" }
      ]
    },
    {
      name: "FSoundHandle",
...
Object.assign(ACS_REF.glossary, {
  "CAudioEngine": "音声再生の中心となるエンジン。<t>FAudioAsset</t> を鳴らし、音量・停止・一時停止を扱う。内部は <t>XAudio2</t>。",
  "FSoundHandle": "再生中の 1 つの音を識別する世代付きの<t>ハンドル</t>。止めた後の取り違えを防ぐ。",
  "FAudioAsset": "wav/mp3/flac/ogg を統一 PCM として読み込んだ音声アセット(asset モジュール)。<t>CAudioEngine</t> に渡して再生する。",
