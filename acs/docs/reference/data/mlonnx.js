  ...
  types: [
    {
      ...
      members: [
        ...
        { sig: "TResult<FMlModelHandle> LoadModel(const char* ModelPath) noexcept", ret: "モデルハンドル", desc: "<code>.onnx</code> ファイルを読み込み、不透明な <t>FMlModelHandle</t> を返す。<code>ModelPath</code> の寿命は呼び出し側が保証する(文字列リテラル等)。<code>nullptr</code> は失敗。", when: "推論したいモデルごとに 1 回。返ったハンドルを <code>RunInference</code> に渡す。"},
