  ...
  types: [
    ...
    },
    {
      ...
      members: [
        ...
        { sig: "void Add(T v)", desc: "末尾に追加し <code>Inserted</code> を通知する。" },
        { sig: "void Pop()", desc: "末尾を削除し <code>Removed</code> を通知する(空なら no-op)。" },
