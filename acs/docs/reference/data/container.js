  ...
  types: [
    ...
    },
    {
      ...
      members: [
        ...
        { sig: "void Shrink()", desc: "余った容量を解放してサイズちょうどに詰める。" },
    ...
    },
    {
      ...
      members: [
        ...
        { sig: "void Reset()", desc: "中身を空にする。" },
        { sig: "const char* GetData() / usize Num() / bool IsEmpty()", desc: "先頭ポインタ(NUL 終端) / バイト長 / 空かどうか。" },
        { sig: "usize Max() const", ret: "確保容量", desc: "現在の確保済み容量(<t>SSO</t> 中は固定の 22)。" },
    ...
    },
    {
      ...
      members: [
        ...
        { sig: "const char* GetData() / usize Num() / bool IsEmpty()", desc: "先頭ポインタ / バイト長 / 空かどうか。" },
    ...
    },
    {
      ...
      members: [
        ...
        { sig: "u32 Num() const", ret: "要素数", desc: "Array / Object の子要素数(スカラなら 0)。" },
