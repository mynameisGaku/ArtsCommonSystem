  ...
  types: [
    ...
    },
    {
      ...
      members: [
        ...
        { sig: "void SetOrbitCameraActive(bool active)", desc: "trueでauthored cameraの自動再選択を抑止してorbit cameraを明示選択し、falseでdeterministic自動選択へ戻す。" },
        ...
        { sig: "bool SetSelectionHighlight(FNodeId subtree_root, FVec3 color, f32 intensity, f32 thickness_pixels)", desc: "一つのnode subtreeへdepth-awareな外側輪郭を設定する。stale handleまたは不正設定では現在値を維持してfalseを返す。" },
        { sig: "void ClearSelectionHighlight()", desc: "設定中の3D選択輪郭を解除する。未設定でも安全。" },
        { sig: "FNodeId SelectionHighlightNode() const", desc: "現在設定中のsubtree rootを返す。未設定または破棄済みではinvalid。" },
