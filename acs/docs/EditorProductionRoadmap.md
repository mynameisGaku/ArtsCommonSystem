...
| Prefab / Blueprint | 保存、配置、Apply/Revert、graph undo、3D stable instance ID、root Visible/Enabled/Color overrideとselective Apply/Revertあり | child/component override、nested prefab、variant、conflict/diff | P2 |
