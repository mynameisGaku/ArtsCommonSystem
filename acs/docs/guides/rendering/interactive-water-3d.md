...
海、プール、水たまり、川は同じrendererを使用し、profile、形状、光学距離、流れ方向を
切り替えます。概要では四つの用途を同じ縮尺で見比べられます。

<figure>
  <a href="../../media/captures/edited/water/interactive-water-overview.png"><img src="../../media/captures/edited/water/interactive-water-overview.png" alt="海、プール、水たまり、川に適用したACS水面の概要" width="1254" height="1254" loading="lazy"></a>
  <figcaption>海、プール、水たまり、川で共通の水面表現</figcaption>
</figure>

次の実行画面は各profileの近景、俯瞰、水面下を示します。

### 海

| 近景 | 遠景 |
|---|---|
| ![海の近景。camera近傍へ格子密度を寄せた風波と深度色](../../media/captures/raw/water/water-ocean-near.png) | ![海の遠景。固定頂点数で広い水面全体を描画](../../media/captures/raw/water/water-ocean-far.png) |

![海の水面下。表側と同じ動的波面を裏側から透過して確認](../../media/captures/raw/water/water-ocean-underwater.png)
...
| 近景 | 水面下 |
|---|---|
| ![プールの近景。底面とlane、壁を透過する低い波高の水面](../../media/captures/raw/water/water-pool-near.png) | ![プールの水面下。浅い光学距離と水面裏側の連続性](../../media/captures/raw/water/water-pool-underwater.png) |
...
| 近景 | 俯瞰 |
|---|---|
| ![水たまりの近景。浅い透過面、object反射、細かな波紋](../../media/captures/raw/water/water-puddle-near.png) | ![水たまりの俯瞰。薄い水膜上の反射と局所的な波](../../media/captures/raw/water/water-puddle-top.png) |
...
| 近景 | 俯瞰 |
|---|---|
| ![川の近景。岸との接触境界、一方向の波、航跡](../../media/captures/raw/water/water-river-near.png) | ![川の俯瞰。細長い水域を流れ方向に伝わる波紋](../../media/captures/raw/water/water-river-top.png) |
